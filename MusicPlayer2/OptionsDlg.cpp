...
BOOL COptionsDlg::OnInitDialog()
{
	...
	m_ai_setting_dlg.Create(IDD_AI_SETTING_DIALOG);
	...
	m_tab_vect.push_back(&m_ai_setting_dlg);
    ...
    m_tab.AddWindow(&m_ai_setting_dlg, theApp.m_str_table.LoadText(L"TITLE_OPT_AI").c_str(), IconMgr::IconType::IT_Online);
